<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\php\PHPTutorial\WWW\tp\public/../application/both\view\index\index.html";i:1565674229;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <meta name="description" content="家园新房属于杭州房产网，新房信息网，主要是为每一位用户提供找房信息，主要包扩新房，公寓，商铺以及杭州房产价格等相关信息" />
    <meta name="baidu-site-verification" content="DnDKprGNb1" />
    <meta name="keywords" content="家园新房 ,一手房信息网,新房最新动态,新房信息网,新房房产" />
...
<body>
    <div class="all container-fluid">
        <nav class="navbox navbar-fixed-top visible-md-block visible-lg-block">
            <div class="na">
                ...
                <span class="city"><?php if(\think\Cookie::get('cityname')): ?> <?php echo \think\Cookie::get('cityname'); else: ?>杭州<?php endif; ?></span>
                <img class="jian" src="/static/home/imgs/icon-10.png" alt="">
                <div class="cities">
                    <ul>
                ...
                <img class="user jk" src="/static/home/imgs/icon-5.png" alt="">
                <span class="my"><?php echo \think\Session::get('user.p'); ?></span>
                <span class="logout">退出</span>
                <?php else: ?>
                <img class="user" src="/static/home/imgs/icon-5.png" alt="">
                <span class="register">注册/登录</span>
                <?php endif; ?>
                <ul class="nav-top">
                    <li role="presentation"><a class="active" href="<?php echo url('both/index/index'); ?>">首页</a></li>
                    <li role="presentation"><a href="<?php echo url('both/search/index',['type'=>0]); ?>">楼盘查询</a></li>
                    <li role="presentation"><a href="<?php echo url('both/search/tuan',['type'=>0]); ?>">团购优惠</a></li>
                    <li role="presentation"><a href="<?php echo url('both/index/buy'); ?>">买房指南</a></li>
                    <li role="presentation"><a href="<?php echo url('both/news/index'); ?>">楼盘资讯</a></li>
                    <li role="presentation"><a href="<?php echo url('both/user/guan'); ?>">关于我们</a></li>
                </ul>
                <span class="gou">购房热线 0571-82576775</span>
            </div>
        </nav>
        <div class="content visible-md-block visible-lg-block">
            <div class="container">
                <img class="b-img" src="/static/home/imgs/321.jpg" alt="家园新房">
                ...
                <form id="bname" style="display: initial" action="<?php echo url('both/search/index',['type'=>0]); ?>"
                    method="post">
                ...
                <div id="map" class="img-btn2"><a href="<?php echo url('pmap'); ?>"><img
                            src="/static/home/imgs/icon-11.png">地图找房</a></div>
            </div>

        </div>
        <div class="icons container-fluid visible-md-block visible-lg-block">
            <div class="row">
                <img src="/static/home/imgs/bo.jpg" alt="">
                <?php if(\think\Cookie::get('cityname')): ?> <?php echo \think\Cookie::get('cityname'); else: ?>杭州<?php endif; ?>在售新房<?php echo $num; ?>个
            </div>
            <ul class="icon">
                <li>
                    <img src="/static/home/imgs/index-icon1.png" alt="家园新房">
                    <h3>家园新房</h3>
                    <p>上千合作新房楼盘，一个温馨 如意放心的家园</p>
                </li>
                <li>
                    <img src="/static/home/imgs/index-icon2.png" alt="专车接送看房">
                    <h3>专车接送看房</h3>
                    <p>免费专车接送，提供专属看房 分析报告</p>
                </li>
                <li>
                    <img src="/static/home/imgs/index-icon3.png" alt="专业服务">
                    <h3>专业服务</h3>
                    <p>专业经纪人一对一服务随时随答 免除你的后顾之忧</p>
                </li>
                <li>
                    <img src="/static/home/imgs/index-icon4.png" alt="团购返现">
                    <h3>团购返现</h3>
                    <p>团购买房可返现,帮助您 省下购房经费</p>
                </li>
            </ul>
        </div>
        ...
        <div class="dongs container-fluid visible-md-block visible-lg-block">
            ...
            <div class="d-list">
                <div class="d-l-row">
                    <h4><img src="/static/home/imgs/dt.png">&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $v['name']; ?>最新房源动态 <span><?php echo $v['create_time']; ?></span></h4>
    ...
    <div class="new container-fluid visible-md-block visible-lg-block">
        <div class="new-box">
            ...
            <ul>
                ...
                <li>
                    <a href="<?php echo url('both/content/content',['id'=>$v['id']]); ?>">
                        <i></i>
                        <img src="<?php echo $v['building_img']; ?>" alt="">
                        <span class="new-name"><?php echo $v['building_name']; ?></span>
                        <span class="new-jia"><?php echo $v['danjia']; ?>/m²</span>
                        <span class="new-city"><?php echo $v['city']; ?></span>
                        <span class="new-ji">面积：<?php echo $v['humianji']; ?>/m²</span>
                    </a>
                </li>
                <?php endforeach; ?>
            </ul>
    ...
    <div class="tuan container-fluid visible-md-block visible-lg-block">
        <h3>团购新房</h3>
        <span class="tuan-description"><img src="/static/home/imgs/icon-6.png">活动说明</span>
        <span class="tuan-advisory"><img src="/static/home/imgs/icon-7.png">点击咨询 <i
                class="t-tel">请拨打电话：0571-82576775</i></span>
        <p>团购新房，一个更省钱的家</p>
        <ul>
            <?php foreach($tuan as $v): ?>
            <li>
                <a href="<?php echo url('both/content/content',['id'=>$v['bid']]); ?>">
                    <i></i>
                    <img src="<?php echo $v['src']; ?>" alt="">
                    <h3><?php echo $v['name']; ?></h3>
                    <h4><?php echo $v['title']; ?></h4>
                    <p>活动时间：<?php echo $v['start']; ?>—<?php echo $v['end']; ?></p>
                </a>
            </li>
            <?php endforeach; ?>
        </ul>
    </div>
    <div class="project container-fluid visible-md-block visible-lg-block">
        <div class="project-box">
            ...
            <ul>
                ...
                <li>
                    <a href="<?php echo url('both/news/pro',['id'=>$v['id']]); ?>">
        ...
        <div class="incro">
            ...
            <div class="i-bottom">
                <p>
                    ...
                    注：1：该活动仅限开发商判定该客户是从“家园新房“网报名认购的客户。具体详情电话咨询-0571-82576775<br>
                    2：最终解释权归“家园新房“所有。
    ...
    <div class="news container-fluid visible-md-block visible-lg-block">
        ...
        <div class="n-1">
            ...
            <ul class="news-left">
                ...
                <a href="<?php echo url('both/news/article',['id'=>$v['id']]); ?>">
                    <li>

                        <span <?php if(($k+1)<=3): ?> class="hot" <?php endif; ?>><?php echo $k+1; ?> </span> <i><?php echo $v['title']; ?></i>
    ...
    <div class="success container-fluid visible-md-block visible-lg-block">
            <div class="box">
                <h4>成交案例</h4>
                <div class="s-content">
                    <div class="s-c-all">
                        ...
                        <div class="row">
                            <div class="s-c-left col-lg-3">
                                <img src="<?php echo $v['img']; ?>" alt="">
                            </div>
                            <div class="s-c-right col-lg-9">
                                <h5><?php echo $v['title']; ?></h5>
                                <p><?php echo $v['content']; ?></p>
                            </div>
                        </div>
                        <?php endforeach; foreach($success as $k=>$v): if($k<3): ?> <div class="row">
                            <div class="s-c-left col-lg-3">
                                <img src="<?php echo $v['img']; ?>" alt="">
                            </div>
                            <div class="s-c-right col-lg-9">
    ...
    <footer class="container-fluid visible-md-block visible-lg-block">
        <ul class="footer-top">
            <a href="<?php echo url('both/user/lian'); ?>">
                <li>联系我们</li>
            </a>
            <a href="<?php echo url('both/user/guan'); ?>">
                <li>关于家园</li>
            </a>
            <a href="<?php echo url('both/news/index'); ?>">
                <li>楼盘资讯</li>
            </a>
            <a href="<?php echo url('both/search/index',['type'=>0]); ?>">
                <li>楼盘查询</li>
            </a>
            <a href="<?php echo url('both/index/buy'); ?>">
                <li>买房指南</li>
            </a>
            <a href="<?php echo url('both/search/tuan',['type'=>0]); ?>">
                <li>团购优惠</li>
            </a>
        </ul>
        ...
        <ul class="youqing">
            ...
            <li><a target="_blank" href="http://www.tj-jcyj.com/">天津衣物清洗</a></li>
        </ul>
    ...
    <div class="container-fluid" style="padding:0;margin: 0">
        ...
        <div class="m-jiao visible-xs-block .visible-sm--block">
            ...
            <div class="m-j-con">
                <a href="<?php echo url('both/index/read',['id'=>$jiao['id']]); ?>">
                    <div class="j-c-left">
        ...
        <div class="visible-xs-block .visible-sm--block m-title">
            <h3 class="m-yan h-active">家园严选</h3>
            <div class="m-y-line"></div>
            <h3 class="m-tuan">团购新房</h3>
        ...
        <div class="visible-xs-block .visible-sm--block m-list">
            <div id="m-list-box">
                ...
                <div class="col-xs-12 m-row">
                    <a href="<?php echo url('both/content/index',['id'=>$v['id']]); ?>">
                ...
                <div class="col-xs-12 m-btn">
                    <a href="<?php echo url('both/search/index',['type'=>'0']); ?>">查看更多房源</a>
                </div>
            </div>
        </div>
        <div class="visible-xs-block .visible-sm--block m-tuans">
            <div id="m-tuans-box">
                <?php foreach($tuan as $v): ?>
                <div class="col-xs-12 m-row">
                    <a href="<?php echo url('both/content/index',['id'=>$v['bid']]); ?>">
                ...
                <?php endforeach; ?>
                <div class="col-xs-12 m-btn">
                    <a href="<?php echo url('both/search/tuan',['type'=>0]); ?>">查看更多房源</a>
                </div>
            </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.d-more').on('click',function(){
                window.location.href="<?php echo url('both/index/dongs'); ?>"
            })
            $('.m-xuan').on('click', function () {
                window.location.href = "<?php echo url('both/index/liu'); ?>";
            })
            ...
            $('.m-jiao h5 span').on('click', function () {
                window.location.href = "<?php echo url('/both/index/jiao'); ?>"
            })
            // 新闻资讯修改
            ...
            $('#map').on('click', function () {
                window.location.href = "<?php echo url('both/index/pmap'); ?>"
            })
            $('.my').on('click', function () {
                window.location.href = "<?php echo url('both/user/zu'); ?>";
            })
            $('.city').on('click', function () {
                $('.cities').slideToggle(200);
            })
            $('.cities ul li').on('click', function () {
                var city = $(this).attr('data-v');
                var name = $(this).html();
                $.post(
                    "<?php echo url('both/index/city'); ?>", {
                        'id': city,
                        'name': name
                    },
                    function (res) {
            ...
            $('.m-btn').on('click', function () {
                ...
                $.post(
                    "<?php echo url('both/user/log'); ?>",
                    data,
                    function (res) {
                        if (res.code == 100) {
                            window.location.href = "<?php echo url('both/index/index'); ?>";
                        } else {
                            alert(res.msg);
                        }
                    }
            ...
            $('.logout').on('click', function () {
                window.location.href = "<?php echo url('both/user/logout'); ?>";
            })
            ...
            $('.m-user').on('click', function () {
                window.location.href = "<?php echo url('both/user/index'); ?>";
            })
            $('.m-sou').on('click', function () {
                window.location.href = "<?php echo url('both/search/ss',['end'=>'index']); ?>";
            })
            $('.m-address').on('click', function () {
                window.location.href = "<?php echo url('both/index/citys'); ?>";
            })
