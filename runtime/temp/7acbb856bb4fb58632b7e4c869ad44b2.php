<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\yushou\create.html";i:1561088520;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="basic">
                <div class="well">
                        ...
                        <label>幢号：</label>
                        <input type="text" name="zhuanghao" value="" class="input-xlarge">
                        <label>可售套数：</label>
                        <input type="text" name="taoshu" value="" class="input-xlarge">
                        <label>户面积：</label>
                        <input type="text" name="humianji" value="" class="input-xlarge">
                        <label>类型：</label>
                        <input type="text" name="type" value="" class="input-xlarge">
                        <label>均价：</label>
                        <input type="text" name="junjia" value="" class="input-xlarge">
                        <label>楼盘地址：</label>
