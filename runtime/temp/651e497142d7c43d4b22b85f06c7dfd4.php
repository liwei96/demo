<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\recording\index.html";i:1553666568;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="content">
    ...
    <div class="well">
        ...
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
                ...
                <tr class="success">
                    ...
                    <td><?php echo $v['zongji']; ?></td>
                    <td><?php echo $v['danjia']; ?></td>
                    <td><?php echo $v['zongjia']; ?></td>
                    <td><?php echo $v['update_time']; ?></td>
                    <td>
                        <a href="<?php echo url('admin/recording/edit',['id'=>$v['id']]); ?>"> 修改 </a>
                        <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='<?php echo url('admin/recording/delete',['id'=>$v['id']]); ?>'">
                            删除 </a>
                    </td>
                </tr>
                <?php endforeach; ?>
        ...
        <a class="btn btn-primary" href="<?php echo url('create',['bid'=>$bid]); ?>">新增</a>
        <!-- pagination -->
