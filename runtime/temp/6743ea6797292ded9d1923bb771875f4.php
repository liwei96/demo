<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\phpstudy_pro\WWW\tp2\public/../application/admin\view\from\edit.html";i:1571111580;s:68:"D:\phpstudy_pro\WWW\tp2\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <form action="<?php echo url('update',['id'=>$data['id']]); ?>" method="post" id="tab" enctype="multipart/form-data">
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="basic">
                <div class="well">
                        <label>关键字：</label>
                        <input type="text" name="key" value="<?php echo $data['key']; ?>" class="input-xlarge">
                        <label>关键字编号：</label>
                        <input type="text" name="kid" value="<?php echo $data['kid']; ?>" class="input-xlarge">
