<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\phpstudy_pro\WWW\tp2\public/../application/admin\view\from\create.html";i:1571130223;s:68:"D:\phpstudy_pro\WWW\tp2\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="content">
    <div class="header">
        <h1 class="page-title">新增<button id="add">+</button></h1>
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="basic">
                <div class="well">
                    ...
                    <label>关键字编号：</label>
                    <input type="text" name="kid[]" value="" class="input-xlarge">
