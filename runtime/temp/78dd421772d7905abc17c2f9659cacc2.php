<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\php\PHPTutorial\WWW\tp\public/../application/home\view\user\find.html";i:1556247601;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
        <meta charset="UTF-8">
        ...
        <div class="m-me visible-xs-block .visible-sm-block">
            <div class="m-shan row">
                ...
                <div class="m-one m-lian">
                   <input type="text" value="<?php echo \think\Session::get('user.phone'); ?>" class="m-in">
                </div>
               <div class="m-s-btn">
                    确定
               </div>
