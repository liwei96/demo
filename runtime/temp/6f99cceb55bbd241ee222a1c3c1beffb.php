<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\phpstudy_pro\WWW\tp2\public/../application/home\view\user\jian.html";i:1569553136;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="content visible-lg-block">
            <div class="box">
                ...
                <div class="col-lg-9 right">
                    <h5>投诉建议</h5>
                    <textarea name="" id="txt" cols="30" rows="10" placeholder="输入您的宝贵建议"></textarea>
                    <p>您有任何问题需要帮助可以写在这里，我们的人员将在最短时间内回复您，感谢您对家园新房的支持！</p>
                    <button class="p-btn">提交</button>
                </div>
            </div>
        </div>
    ...
    <script>
	   ...
	   $('.user').on('click',function(){
            ...
            $('.p-btn').on('click',function(){
                var con=$('#txt').val();
                $.post(
                    "<?php echo url('home/user/jian'); ?>",
                    {'con':con},
                    function(res){
                        if(res.code==200){
                            $('#txt').val('');
                            $('#txt').attr('placeholder','提交成功，我们会尽快解决您反馈的问题');
                        }
                    }
                )
            })
