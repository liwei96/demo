<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\news\index.html";i:1555998585;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="content">
    ...
    <div class="well">
        <!-- search button -->
        <form action="<?php echo url('admin/news/save'); ?>" method="post" class="form-search">
            <label>楼盘简介：</label>
