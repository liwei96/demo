<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\tuan\index.html";i:1554613125;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="basic">
                <div class="well">
                        ...
                        <label>开始时间：</label>
                        <input name="start" type="date" value="2015-09-24T"/>
                        <label>结束时间：</label>
                        <input name="end" type="date" value="2015-09-24T"/>
                        <label>团购内容：</label>
