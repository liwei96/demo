<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\phpstudy_pro\WWW\tp2\public/../application/home\view\search\search.html";i:1571034662;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="buildings visible-md-block visible-lg-block">
            <div class="box">
                ...
                <div class="pages">
                    <span id="back"><<</span>
                    <ul class="page">
                        <?php $__FOR_START_663805865__=0;$__FOR_END_663805865__=$page;for($i=$__FOR_START_663805865__;$i < $__FOR_END_663805865__;$i+=1){ if($i<7): ?>
