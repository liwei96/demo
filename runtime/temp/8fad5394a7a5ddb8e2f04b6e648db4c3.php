<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\auth\edit.html";i:1553220526;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="content">
    ...
    <div class="well">
        <!-- add form -->
        <form id="tab" action="<?php echo url('admin/auth/update',['id'=>$data['id']]); ?>" method="post">
            <label>权限名称：</label>
            ...
            <select name="pid" class="input-xlarge">
                ...
                <option value="<?php echo $v['id']; ?>" <?php if($data['pid']==$v['id']): ?>selected<?php endif; ?>><?php echo $v['auth_name']; ?></option>
                <?php endforeach; ?>
            </select>
            <div>
                <label>控制器：</label>
