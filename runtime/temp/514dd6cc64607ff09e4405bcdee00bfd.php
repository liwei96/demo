<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\attr\index.html";i:1555310471;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="content">
    <div class="header">
        <h1 class="page-title">楼盘属性编辑</h1>
    </div>

    <div class="well">
        <!-- search button -->
        <form action="<?php echo url('admin/attr/save'); ?>" method="post" class="form-search">
            <div class="row-fluid" style="text-align: left;">
                <div class="pull-left span4 unstyled">
                    <p> 城市：<input class="input-medium" name="c" type="text"></p>
                    <p> 分区：<input class="input-medium" name="f" type="text"></p>
                </div>
            </div>
