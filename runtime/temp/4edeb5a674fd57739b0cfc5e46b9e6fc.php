<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\success\edit.html";i:1561011638;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <form action="<?php echo url('update',['id'=>$data['id']]); ?>" method="post" id="tab" enctype="multipart/form-data">
        <div class="tab-content">
            <div class="tab-pane fade in active" id="basic">
                <div class="well">
                        <label>事例标题：</label>
                        <input type="text" name="title" value="<?php echo $data['title']; ?>" class="input-xlarge">
                        <label>录入人员：</label>
                        <input type="text" name="people" value="<?php echo $data['people']; ?>" class="input-xlarge">
                        <label>事例主图：</label>
                        <input type="file" name="news_logo" value="<?php echo $data['img']; ?>" class="input-xlarge">
                        <label>事例内容：</label>
                        <textarea id="editor" name="content" style="width:800px;height:500px;" class="input-xlarge"><?php echo $data['content']; ?></textarea>
                </div>
            </div>
