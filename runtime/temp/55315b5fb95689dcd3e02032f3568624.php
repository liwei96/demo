<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\user\shou.html";i:1556937953;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="content">
    ...
    <div class="well">
        <!-- search button -->
        <form action="<?php echo url('admin/user/shou'); ?>" method="post" class="form-search">
    ...
    <div class="well">
        ...
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
                ...
                <tr class="success">
                    <td><?php echo $v['id']; ?></td>
                    <td><?php echo $v['building_name']; ?></td>
                    <td><?php echo $v['phone']; ?></td>
                    <td><?php echo $v['name']; ?></td>
                    <td><?php echo $v['type']; ?></td>
                    <td><?php echo $v['address']; ?></td>
                    <td><?php if($v['is_over']=='1'): ?>已联系<?php else: ?><a class="as" href="#" data_v="<?php echo $v['id']; ?>">未联系</a><?php endif; ?></td>
                    <td><?php echo $v['create_time']; ?></td>
                    <td>
                        <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='<?php echo url('admin/user/d',['id'=>$v['id']]); ?>'">
                            删除 </a>
                    </td>
                </tr>
                <?php endforeach; ?>
