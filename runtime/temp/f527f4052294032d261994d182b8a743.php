<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\php\PHPTutorial\WWW\tp\public/../application/home\view\search\tuan.html";i:1564905070;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<a href="<?php echo url('home/content/content',['id'=>$v['id']]); ?>">
                                    ...
                                    <p>金牌职业顾问&nbsp;&nbsp;&nbsp;<button class="zixun" data-v="<?php echo $v['building_name']; ?>"><img src="/static/home/imgs/pc-tel.png">咨询</button></p>
                ...
                <div class="pages">
                    <span id="back"><<</span>
                    <ul class="page">
                        <?php $__FOR_START_1215915456__=0;$__FOR_END_1215915456__=$page;for($i=$__FOR_START_1215915456__;$i < $__FOR_END_1215915456__;$i+=1){ if($i<7): ?>
                    ...
                    <div class="fix">
                        ...
                        <div class="lou">
                            <a href="<?php echo url('home/content/content',['id'=>$v['id']]); ?>">
                            <img src="<?php echo $v['building_img']; ?>" alt="">
                            <h6><?php echo $v['building_name']; ?></h6>
                            <p><?php echo $v['qu']; ?>  |  <?php echo $v['building_address']; ?></p>
                            <p>参考均价：</p>
                            <p class="hot-pri"><span><?php echo $v['danjia']; ?></span>元/m²</p>
                            </a>
                        </div>
                        <?php endforeach; ?>
...
<a href="/home/content/content/id/${v.id}">
                            ...
                            $('.page').html(h);
                                ...
                                <div class="visible-xs-block .visible-sm--block m-kong">
                                    ...
                                    <a class="m-lian" href="tel:0571-82576775">联系我们</a>
