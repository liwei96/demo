<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\yushou\edit.html";i:1561088883;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="basic">
                <div class="well">
                        ...
                        <label>核发日期：</label>
                        <input type="date" name="time" value="<?php echo $data['time']; ?>" class="input-xlarge">
                        <label>幢号：</label>
                        <input type="text" name="zhuanghao" value="<?php echo $data['zhuanghao']; ?>" class="input-xlarge">
                        <label>可售套数：</label>
                        <input type="text" name="taoshu" value="<?php echo $data['taoshu']; ?>" class="input-xlarge">
                        <label>户面积：</label>
                        <input type="text" name="humianji" value="<?php echo $data['humianji']; ?>" class="input-xlarge">
                        <label>类型：</label>
                        <input type="text" name="type" value="<?php echo $data['type']; ?>" class="input-xlarge">
                        <label>均价：</label>
                        <input type="text" name="junjia" value="<?php echo $data['junjia']; ?>" class="input-xlarge">
                        <label>楼盘地址：</label>
