<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\phpstudy_pro\WWW\tp2\public/../application/admin\view\wen\index.html";i:1571884106;s:68:"D:\phpstudy_pro\WWW\tp2\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="content">
    ...
    <div class="well">
        <!-- search button -->
        <form action="<?php echo url('admin/wen/index'); ?>" method="post"  class="form-search">
            楼盘：<input type="text" name="name">
