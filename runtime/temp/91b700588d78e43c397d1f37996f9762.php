<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\yaohao\index.html";i:1561084614;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="content">
    <div class="header">
        <h1 class="page-title">摇号列表</h1>
    </div>

    <div class="well">
        <!-- search button -->
        <form action="<?php echo url('admin/yaohao/index'); ?>" method="post" class="form-search">
        ...
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
                ...
                <tr class="success">
                    ...
                    <td><?php echo $v['loupan']; ?></td>
                    <td><?php echo $v['time']; ?></td>
                    <td><?php echo $v['type']; ?></td>
                    <td>
                        <a href="<?php echo url('admin/yaohao/edit',['id'=>$v['id']]); ?>"> 编辑 </a>
                        <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='<?php echo url('admin/yaohao/delete',['id'=>$v['id']]); ?>'">
                            删除 </a>
                    </td>
                </tr>
                <?php endforeach; ?>
