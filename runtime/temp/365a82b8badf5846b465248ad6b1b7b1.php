<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\phpstudy_pro\WWW\tp2\public/../application/admin\view\you\index.html";i:1571032870;s:68:"D:\phpstudy_pro\WWW\tp2\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
                ...
                <tr class="success">
                    ...
                    <td>
                        <a href="<?php echo url('admin/you/edit',['id'=>$v['id']]); ?>"> 编辑 </a>
                        <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='<?php echo url('admin/you/delete',['id'=>$v['id']]); ?>'">
                            删除 </a>
                    </td>
                </tr>
                <?php endforeach; ?>
