<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\php\PHPTutorial\WWW\tp\public/../application/home\view\search\search.html";i:1565488239;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<a href="<?php echo url('home/content/content',['id'=>$v['id']]); ?>">
                ...
                <div class="pages">
                    <span id="back"><<</span>
                    <ul class="page">
                        <?php $__FOR_START_993232466__=0;$__FOR_END_993232466__=$page;for($i=$__FOR_START_993232466__;$i < $__FOR_END_993232466__;$i+=1){ if($i<7): ?>
    ...
    <div class="container-fluid m">
        ...
        <div class="m-search visible-xs-block .visible-sm--block">
            ...
            <input type="text" name="name" class="m-int" placeholder="请输入楼盘名称">
