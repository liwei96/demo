<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\role\create.html";i:1541324087;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="content">
    ...
    <div class="well">
        <!-- add form -->
        <form action="<?php echo url('admin/role/save'); ?>" method="post" id="tab">
            <label>角色名：</label>
