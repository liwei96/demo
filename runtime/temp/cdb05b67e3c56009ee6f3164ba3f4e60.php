<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\hnews\index.html";i:1556248047;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
                ...
                <tr class="success">
                    ...
                    <td>
                        <a href="<?php echo url('admin/hnews/edit',['id'=>$v['id']]); ?>"> 编辑 </a>
                        <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='<?php echo url('admin/hnews/delete',['id'=>$v['id']]); ?>'">
                            删除 </a>
                    </td>
                </tr>
                <?php endforeach; ?>
