<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:74:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\user\index.html";i:1556262090;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
                ...
                <tr class="success">
                    ...
                    <td><?php echo $v['huxing']; ?></td>
                    <td><?php echo $v['tese']; ?></td>
                    <td><?php echo $v['phone']; ?></td>
                    <td><?php if($v['is_over']=='0'): ?><a class="as" href="#" data_v="<?php echo $v['id']; ?>">未解决</a><?php else: if($v['is_over']=='1'): ?>已解决<?php endif; endif; ?></td>
                    <td><?php echo $v['create_time']; ?></td>
                    <td>
                        <a href="javascript:void(0);" onclick="if(confirm('确认删除？')) location.href='<?php echo url('admin/user/delete',['id'=>$v['id']]); ?>'">
                            删除 </a>
                    </td>
                </tr>
                <?php endforeach; ?>
