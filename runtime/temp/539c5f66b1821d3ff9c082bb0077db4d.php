<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\success\create.html";i:1561109567;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="basic">
                <div class="well">
                        ...
                        <label>成交楼盘：</label>
                        <input type="text" name="lou" value="" class="input-xlarge">
                        <label>录入人员：</label>
                        <input type="text" name="people" value="" class="input-xlarge">
                        <label>事例主图：</label>
                        <input type="file" name="news_logo" value="" class="input-xlarge">
                        <label>事例内容：</label>
