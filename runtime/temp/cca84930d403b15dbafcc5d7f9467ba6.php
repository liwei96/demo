<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\php\PHPTutorial\WWW\tp\public/../application/home\view\search\sou.html";i:1557885452;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container-fluid all">
        <form class="m-search visible-xs-block .visible-sm-block" action="/index.php/home/search/<?php echo $end; ?>/type/0" method="POST">
    ...
    <div class="container-fluid hot">
        <h4 class="visible-xs-block">热门搜索</h4>
        ...
        $(document).ready(function(){
            $('#ys span').on('click',function(){
                ...
                if('<?php echo $end; ?>'=='index' || '<?php echo $end; ?>'=='search'){
                    window.location.href="/index.php/home/search/index/type/"+s;
                }else if('<?php echo $end; ?>'=='tuan'){
                    window.location.href="/index.php/home/search/tuan/type/"+s;
                }
            })
        })
