<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\yaohao\edit.html";i:1561085982;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="basic">
                <div class="well">
                        ...
                        <label>楼盘：</label>
                        <input type="text" name="loupan" value="<?php echo $data['loupan']; ?>" class="input-xlarge">
                        <label>时间：</label>
                        <input name="time" type="text" value="<?php echo $data['time']; ?>"/>
                        <label>分类：</label>
                        <select name="type" id="">
                            <option value="登记" <?php if($data['type']=='登记'): ?> selected <?php endif; ?>>登记</option>
                            <option value="摇号" <?php if($data['type']=='摇号'): ?> selected <?php endif; ?>>摇号</option>
                        </select> 
