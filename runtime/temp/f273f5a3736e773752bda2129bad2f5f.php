<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\php\PHPTutorial\WWW\tp\public/../application/home\view\index\index.html";i:1565342372;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="news container-fluid visible-md-block visible-lg-block">
        ...
        <div class="n-1">
            ...
            <ul class="news-left">
                ...
                <a href="<?php echo url('home/news/article',['id'=>$v['id']]); ?>">
                    <li>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('.m-xuan').on('click', function () {
                window.location.href = "<?php echo url('home/index/liu'); ?>";
            })
