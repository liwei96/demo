<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\yaohao\create.html";i:1561085805;s:70:"D:\php\PHPTutorial\WWW\tp\public/../application/admin\view\layout.html";i:1553218686;}*/ ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="tab-content">
            <div class="tab-pane fade in active" id="basic">
                <div class="well">
                        ...
                        <label>楼盘：</label>
                        <input type="text" name="loupan" value="" class="input-xlarge">
                        <label>时间：</label>
